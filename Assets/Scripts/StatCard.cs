...
public class StatCard : MonoBehaviour
{
    ...
    {
        //if (GameManager.Instance.CurrentRosterSize != GameManager.Instance.MaxRosterSize)
        //{
        //    Debug.Log("Selected " + _criminal.Name);
        //    CriminalManager.Instance.UpdateRoster(_criminal);
        //    GameManager.Instance.CurrentRosterSize++;
        //    Destroy(this.gameObject);
        //}
        //else
        //{
        //    // To-Do: Notification display system 
